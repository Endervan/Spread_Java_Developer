...
//Entrada
//A entrada contém vários casos de teste. A primeira e única linha de
// cada caso de teste contém quatro inteiros X1, Y1, X2 e Y2 (1 ≤ X1, Y1, X2, Y2 ≤ 8).
// A dama começa na casa de coordenadas (X1, Y1), e a casa de destino é a casa de coordenadas(X2, Y2).
// No tabuleiro, as colunas são numeradas da esquerda para a direita de 1 a 8 e as linhas de cima para
...
// linha na saída, contendo um número inteiro, indicando o menor número de movimentos
